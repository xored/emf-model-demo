 ...
 * <ul>
 *   <li>{@link com.xored.estore_demo.persistence.impl.RootObjectImpl#getUri <em>Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RootObjectImpl extends MinimalEObjectImpl.Container implements RootObject {
	...
	protected EClass eStaticClass() {
		return PersistencePackage.Literals.ROOT_OBJECT;
	}
	...
	public void setUri(String newUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PersistencePackage.ROOT_OBJECT__URI, oldUri, uri));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PersistencePackage.ROOT_OBJECT__URI:
				return getUri();
		}
